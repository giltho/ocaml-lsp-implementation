(** This module defines textDocumentClientCapabilities. They are on of the
    component of {!ClientCapabilities} They are composed of several elements
    that we define and use in this module *)
...
module Completion = struct
  ...
  module CompletionItemKind = struct
    type t = { valueSet : (CompletionItemKind.t list[@default []]) }
    [@@deriving yojson { strict = false }]
  ...
  type t = {
    dynamicRegistration : (bool[@default false]);
    completionItem : (CompletionItem.t[@default CompletionItem.default]);
    completionItemKind :
...
module SignatureHelp = struct
  module SignatureInformation = struct
    module ParameterInformation = struct
      type t = { labelOffsetSupport : bool [@default false] }
      [@@deriving yojson { strict = false }]
    ...
    type t = {
      ...
      parameterInformation : ParameterInformation.t
          [@default ParameterInformation.default]
    }
    [@@deriving yojson { strict = false }]
  ...
  type t = {
    ...
    signatureInformation :
      (SignatureInformation.t[@default SignatureInformation.default])
  }
  [@@deriving yojson]
